...
class TestUnits(unittest.TestCase):
    ...
    def test_get_exif(self):
        ...
        """
        result = exif_tool.get_exif_datetime('test/jelena_dokic.jpg')
    ...
    def test_get_exception_handles(self):
        ...
        """
        result = exif_tool.get_exif_datetime('test/gym_drink_ad.jpg')
        ...
        result = exif_tool.get_exif_datetime('requirements.txt')
    ...
    def test_set_jpg(self):
        ...
        """
        result = exif_tool.set_exif_datetime('test/299352.jpg', 2016, 5, 15, 16, 0, 5)
        self.assertEqual(result, 0)

        result = exif_tool.get_exif_datetime('test/299352.jpg')
